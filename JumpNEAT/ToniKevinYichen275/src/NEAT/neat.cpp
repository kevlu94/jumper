...
bool NEAT::load_neat_params(const char *filename, bool output) {
	...
	// **********LOAD IN PARAMETERS*************** //
    if(output)
	    fprintf(stderr, "NEAT READING IN %s", filename);
    ...
    if(output) {
	    fprintf(stderr, "trait_param_mut_prob=%f\n",trait_param_mut_prob);
	    fprintf(stderr, "trait_mutation_power=%f\n",trait_mutation_power);
	    fprintf(stderr, "linktrait_mut_sig=%f\n",linktrait_mut_sig);
	    fprintf(stderr, "nodetrait_mut_sig=%f\n",nodetrait_mut_sig);
	    fprintf(stderr, "weight_mut_power=%f\n",weight_mut_power);
	    fprintf(stderr, "recur_prob=%f\n",recur_prob);
	    fprintf(stderr, "disjoint_coeff=%f\n",disjoint_coeff);
	    fprintf(stderr, "excess_coeff=%f\n",excess_coeff);
	    fprintf(stderr, "mutdiff_coeff=%f\n",mutdiff_coeff);
	    fprintf(stderr, "compat_threshold=%f\n",compat_threshold);
	    fprintf(stderr, "age_significance=%f\n",age_significance);
	    fprintf(stderr, "survival_thresh=%f\n",survival_thresh);
	    fprintf(stderr, "mutate_only_prob=%f\n",mutate_only_prob);
	    fprintf(stderr, "mutate_random_trait_prob=%f\n",mutate_random_trait_prob);
	    fprintf(stderr, "mutate_link_trait_prob=%f\n",mutate_link_trait_prob);
	    fprintf(stderr, "mutate_node_trait_prob=%f\n",mutate_node_trait_prob);
	    fprintf(stderr, "mutate_link_weights_prob=%f\n",mutate_link_weights_prob);
	    fprintf(stderr, "mutate_toggle_enable_prob=%f\n",mutate_toggle_enable_prob);
	    fprintf(stderr, "mutate_gene_reenable_prob=%f\n",mutate_gene_reenable_prob);
	   	fprintf(stderr, "mutate_add_node_prob=%f\n",mutate_add_node_prob);
		fprintf(stderr, "mutate_add_link_prob=%f\n",mutate_add_link_prob);
	    fprintf(stderr, "interspecies_mate_rate=%f\n",interspecies_mate_rate);
	    fprintf(stderr, "mate_multipoint_prob=%f\n",mate_multipoint_prob);
	    fprintf(stderr, "mate_multipoint_avg_prob=%f\n",mate_multipoint_avg_prob);
	    fprintf(stderr, "mate_singlepoint_prob=%f\n",mate_singlepoint_prob);
	    fprintf(stderr, "mate_only_prob=%f\n",mate_only_prob);
	    fprintf(stderr, "recur_only_prob=%f\n",recur_only_prob);
	    fprintf(stderr, "pop_size=%d\n",pop_size);
	    fprintf(stderr, "dropoff_age=%d\n",dropoff_age);
	    fprintf(stderr, "newlink_tries=%d\n",newlink_tries);
	    fprintf(stderr, "print_every=%d\n",print_every);
	    fprintf(stderr, "babies_stolen=%d\n",babies_stolen);
