...
//    testdoub=&val;
  ...
  */
  ...
  cerr<<"Please choose an experiment: "<<endl;
  cerr<<"1 - 1-pole balancing"<<endl;
  cerr<<"2 - 2-pole balancing, velocity info provided"<<endl;
  cerr<<"3 - 2-pole balancing, no velocity info provided (non-markov)"<<endl;
  cerr<<"4 - XOR"<<endl;
  cerr<<"Number: ";
  ...
  switch ( choice )
    ...
    case 4:
      ...
      break;
    default:
      cerr<<"Not an available option."<<endl;
    }
