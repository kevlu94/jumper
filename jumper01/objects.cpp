...
void Human::setHuman(glm::vec3 size)
{
    ...
    m_torso.setColoredBox(1.0f, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.2f, 1.9f, 0.2f));
    m_leftUpperArm.setColoredBox(1.0f, glm::vec3(0.3f, 0.3f, 0.0f), glm::vec3(0.1f, 0.9f, 0.1f));
    m_rightUpperArm.setColoredBox(1.0f, glm::vec3(0.0f, 0.3f, 0.3f), glm::vec3(0.1f, 0.9f, 0.1f));
    m_leftLowerArm.setColoredBox(1.0f, glm::vec3(0.6f, 0.3f, 0.0f), glm::vec3(0.1f, 0.9f, 0.1f));
    m_rightLowerArm.setColoredBox(1.0f, glm::vec3(0.0f, 0.3f, 0.6f), glm::vec3(0.1f, 0.9f, 0.1f));
    ...
    m_rightFoot.setColoredBox(1.0f, glm::vec3(0.0f, 0.0f, 0.9f), glm::vec3(0.3f, 0.1f, 0.8f));
